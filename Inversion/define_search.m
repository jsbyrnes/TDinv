...
%parameters, and so on.
    ...
    inverse_parameters.iter                  = 3e5; %number of iterations of the neighborhoods
    inverse_parameters.writeOutOn            = 1e1;%how often to print to the screen
    ...
    inverse_parameters.burnin                = 1e5;%kill chain if you haven't converged here - nonconverging ones take FOREVER to finish
